...
@AllArgsConstructor
@Builder
@Schema(description = "그룹 책 댓글 생성 요청 DTO")
public class GroupBookCommentCreateRequest {

    @NotNull(message = "그룹 책 ID는 필수입니다")
    @Schema(description = "그룹 책 ID", example = "1001", required = true)
