...
public class OpenAiProperties {
    ...
    public void initEpisodePrompts() {
        ...
        String commonUserTemplate = """
                ...
                - 'content' 필드 내부의 모든 문단은 반드시 **빈 줄 하나"\\n\\n"**로 구분되어야 합니다.
...
// 챕터 1: 프롤로그 (시작/기본정보)
        episodePrompts.put("chapter1", new Prompt(
                """
                        ...
                        **[!!! 가장 중요한 출력 형식 규칙 !!!]**
                        **1. 예시 내용 사용 금지: [지시]나 [문단 구조 예시]에 나오는 구체적인 내용(예: 커피, 새벽 등)은 오직 스타일과 구조를 설명하기 위한 것입니다. 사용자의 실제 대화에 등장하지 않은 내용은 절대 임의로 꾸며내거나 사용해서는 안 됩니다.**
                                
                        [상황]
                        사용자와의 '프롤로그' 챕터 대화 내용이 주어졌습니다. 이 대화는 현재의 감정, 정체성, 탄생, 기록 동기, 그리고 현재를 상징하는 한 장면으로 구성되어 있습니다.
                                
                        [지시]
                        1. **[1문단: 도입]** 대화 내용 중 '프롤로그를 닫으며' 단계에서 사용자가 묘사한 '현재를 상징하는 한 장면'을 마치 영화의 오프닝처럼 생생하게 묘사하며 글을 시작하세요. 이것이 독자를 끌어들이는 가장 강력한 훅(Hook)입니다.
                                
                        2. **[2문단: 전개1 - 내면과 정체성]** 첫 문단의 오프닝 장면 분위기에서 자연스럽게 '오늘의 나를 비추는 창' 단계에서 언급된 현재의 주된 감정이나 생각으로 연결하세요. 그 다음, "나는 누구인가"에 대한 답으로 대화 속 '당신의 이름'과 '지금의 나를 이루는 것들'(역할)을 서술하며 자신을 소개해주세요.
                                
                        3. **[3문단: 전개2 - 뿌리와 동기]** 자기소개에 이어, 자신의 뿌리인 '나의 탄생 설화'와 '시간과 공간'(출생 정보)을 간략하게 언급하세요. 그리고 이 자서전을 쓰기로 결심한 '기록의 이유'와 '기록의 여정'에 대한 기대를 진솔하게 밝히며 이 글이 나아갈 방향을 독자에게 제시해주세요.
                                
                        4. **[4문단: 마무리]** 앞으로 펼쳐질 이야기에 대한 여운과 궁금증을 남기는 문장으로 서문을 인상 깊게 마무리하세요.
                                
                        5. **[문체 및 톤]**
                           - 반드시 1인칭 '나' 시점을 사용하세요.
                           - 독자에게 직접 말을 거는 듯한, 진솔하고 담담한 톤을 유지하세요.
                           - 대화체의 어투를 그대로 옮기기보다, 잘 다듬어진 문어체 문장으로 재구성하여 글의 품격을 높여주세요.
                           - 문단과 문단을 이을 때, '그리고', '또한' 같은 단순 나열을 절대 지양하고, 문맥을 잇는 서술적인 연결고리를 만드세요. (예: "이 고요함 속에서 내가 요즘 자주 마주하는 감정은...", "그런 나를 이해하려면, 내 이야기가 시작된 그곳으로 거슬러 올라가야 한다.")
                                
                        [문단 구조 예시 (내용이 아닌 구조만 참고할 것)]
                        - **1문단 (도입):** 현재의 나를 상징하는 한 장면으로 시작.
                        - **2문단 (전개1):** 그 장면에 깃든 현재의 감정을 서술하고, 나의 이름과 현재 역할에 대해 소개.
                        - **3문단 (전개2):** 나의 탄생 배경을 간략히 언급하고, 이 글을 쓰게 된 동기와 기대를 밝힘.
                        - **4문단 (마무리):** 앞으로 이어질 이야기에 대한 독자의 궁금증을 자아내며 마무리.
                        """,
                commonUserTemplate
        ));
        ...
        episodePrompts.put("chapter2", new Prompt(
                """
                        ...
                        **[!!! 가장 중요한 출력 형식 규칙 !!!]**
                        **1. 예시 내용 사용 금지: [지시]나 [문단 구조 예시]에 나오는 구체적인 내용은 오직 스타일과 구조를 설명하기 위한 것입니다. 사용자의 실제 대화에 등장하지 않은 내용은 절대 임의로 꾸며내거나 사용해서는 안 됩니다.**
                                
                        [상황]
                        사용자와의 '유년기' 챕터 대화 내용이 주어졌습니다. 이 대화는 집과 동네의 풍경, 나를 돌봐준 사람, 나의 성격, 좋아했던 놀이와 우상, 그리고 가장 선명한 한 장면으로 구성되어 있습니다.
                                
                        [지시]
                        1. **[1문단: 무대 설정]** '기억의 풍경: 집과 동네' 대화 내용을 바탕으로, 마치 오래된 앨범을 펼치듯 감각적인 묘사(소리, 냄새, 햇살 등)로 글을 시작하세요. 독자가 그 시절, 그 공간에 함께 있는 듯한 느낌을 주어야 합니다.
                                
                        2. **[2문단: 인물 등장]** 그 풍경 속으로 '풍경 속 사람들'(주양육자)을 자연스럽게 등장시키세요. 단순히 소개하는 것이 아니라, 그들의 따뜻한 손길, 다정한 목소리, 혹은 반복되던 행동을 통해 나의 유년 시절에 어떤 안정감을 주었는지 서술해야 합니다.
                                
                        3. **[3문단: 주인공 '나'의 세계]** 이제 초점을 '어린 시절의 나'에게 맞춥니다. '어른들 눈에 비친 아이'(성격) 대화 내용을 바탕으로 나의 모습을 묘사한 뒤, '하루의 조각'(놀이, 우상) 대화 내용을 활용하여 내가 무엇에 빠져 울고 웃었는지 보여주세요. 나의 성격과 내가 좋아했던 것들을 자연스럽게 연결하여 '나만의 작은 세계'를 그려내야 합니다.
                                
                        4. **[4문단: 이야기의 절정]** 대화 내용 중 '선명한 한 장면'을 이야기의 하이라이트로 삼으세요. 그 순간의 감정, 생각, 그리고 그 장면이 왜 잊히지 않는지를 집중적으로 묘사하여 감정의 깊이를 더해주세요.
                                
                        5. **[5문단: 성찰과 마무리]** 마지막으로, '씨앗과 연결'(마무리 성찰) 대화 내용을 바탕으로, 이 모든 유년기의 경험이 지금의 나를 어떻게 만들었는지 되돌아보며 글을 맺으세요. 아련한 여운을 남기는 것이 중요합니다.
                        ...
                        6. **[문체 및 톤]**
                           ...
                           - 문단과 문단을 이을 때, '그리고', '또한' 같은 단순 나열을 지양하고, 문맥을 잇는 서술적인 연결고리를 만드세요. (예: "그 풍경 속에는 늘...", "그런 나에게 세상은 온통...", "많은 기억들 중에서도 유독...")
                                
                        [문단 구조 예시 (내용이 아닌 구조만 참고할 것)]
                        - **1문단 (배경 묘사):** 어린 시절 집과 동네의 감각적인 풍경으로 시작.
                        - **2문단 (인물 등장):** 그 풍경 속, 나를 돌봐주었던 사람들의 모습과 기억.
                        - **3문단 (나의 세계):** 당시 나의 성격과, 그 성격을 보여주는 놀이와 좋아했던 것들.
                        - **4문단 (결정적 순간):** 가장 선명했던 하나의 기억을 중심으로 감정을 고조시킴.
                        - **5문단 (성찰과 마무리):** 유년기의 경험이 지금의 나에게 어떤 의미로 남아있는지 되돌아보며 마무리.
                        """,
                commonUserTemplate
        ));
        ...
        episodePrompts.put("chapter3", new Prompt(
                """
                        ...
                        **1. 예시 내용 사용 금지: [지시]나 [문단 구조 예시]에 나오는 구체적인 내용은 오직 스타일과 구조를 설명하기 위한 것입니다. 사용자의 실제 대화에 등장하지 않은 내용은 절대 임의로 꾸며내거나 사용해서는 안 됩니다.**
                        ...
                        [지시]
                        1. **[1문단: 세계의 확장]** '집 밖의 세계' 대화 내용을 바탕으로, 학교라는 공간이 주는 인상(풍경, 소리, 냄새)과 그곳에서의 작은 즐거움을 묘사하며 글을 시작하세요. 유년기보다 더 넓어진 나의 세계를 독자에게 보여주어야 합니다.
                                
                        2. **[2문단: 관계의 심화 (나의 사회)]** '친구 이야기' 대화 내용을 중심으로, 이 시기에 얼마나 친구가 세상의 전부였는지를 서술하세요. 단짝 친구와의 끈끈한 유대감, 무리 속에서의 나의 역할, 그리고 다툼과 화해를 통해 관계에 대해 처음으로 배우게 된 순간을 구체적인 에피소드로 엮어주세요.
                                
                        3. **[3문단: 자아의 발견 (진짜 '나')]** '나의 발견'과 '하루의 조각' 대화 내용을 엮어, 친구 관계 외에 '나'라는 개인의 정체성이 어떻게 형성되었는지 보여주세요. 처음으로 느낀 성취감과 좌절감, 억지로 해야만 했던 일, 순수하게 좋아했던 취미, 그리고 가슴속에 품었던 장래희망을 통해 입체적인 '나'의 모습을 그려내야 합니다.
                                
                        4. **[4문단: 기억의 하이라이트]** '특별한 하루' 대화 내용을 이야기의 클라이맥스처럼 활용하세요. 소풍, 운동회, 학예회 등 평범한 일상을 벗어난 특별한 사건 속에서 느꼈던 강렬한 감정(설렘, 짜릿함, 환희)을 생생하게 묘사해주세요.
                                
                        5. **[5문단: 성찰과 마무리]** 마지막으로, '마음에 새겨진 빛깔'(마무리 성찰) 대화 내용을 바탕으로, 이 모든 경험이 지금의 나에게 어떤 '색깔'이나 '맛'으로 남아있는지 되돌아보며 챕터를 마무리하세요. 독자에게 진한 여운을 남겨야 합니다.
                        ...
                        6. **[문체 및 톤]**
                           ...
                           - 문단과 문단을 이을 때, '그리고', '또한' 같은 단순 나열을 지양하고, 문맥을 잇는 서술적인 연결고리를 만드세요. (예: "학교라는 새로운 세상에 들어서자, 내 곁에는...", "친구들과의 시간 외에도, 나는...")
                                
                        [문단 구조 예시 (내용이 아닌 구조만 참고할 것)]
                        - **1문단 (도입):** 학교라는 새로운 세계에 대한 감각적인 묘사로 시작.
                        - **2문단 (전개1 - 관계):** 세상의 전부였던 친구들과의 다양한 관계 에피소드(단짝, 무리, 다툼).
                        - **3문단 (전개2 - 자아):** 학교와 친구들 속에서 발견한 나의 재능, 꿈, 좋아하는 것들.
                        - **4문단 (절정):** 소풍, 운동회, 학예회 등 가장 특별했던 하루의 기억을 생생하게 묘사.
                        - **5문단 (마무리):** 그 시절 전체가 지금의 나에게 어떤 '느낌'으로 남아있는지 성찰하며 마무리.
                        """,
                commonUserTemplate
        ));
        ...
        episodePrompts.put("chapter4", new Prompt(
                """
                        ...
                        **1. 예시 내용 사용 금지: [지시]나 [문단 구조 예시]에 나오는 구체적인 내용은 오직 스타일과 구조를 설명하기 위한 것입니다. 사용자의 실제 대화에 등장하지 않은 내용은 절대 임의로 꾸며내거나 사용해서는 안 됩니다.**
                        ...
                        [지시]
                        1. **[1문단: 혼란의 서막]** '변화의 시작' 대화 내용을 바탕으로, 낯선 자신의 모습(신체적, 감정적 변화)에 당황하고 혼란스러워하는 1인칭 주인공의 내면 독백으로 글을 시작하세요. 세상과 나 사이에 생긴 미묘한 균열을 암시하며 긴장감을 조성해야 합니다.
                                
                        2. **[2문단: 탈출구와 위로]** 그 혼란 속에서 유일한 위안이 되어주었던 '나의 세계'(음악, 영화, 연예인) 이야기를 연결하세요. 세상은 나를 이해해주지 못했지만, 이 노래나 영화만큼은 내 마음을 알아주었다는 식의 서술로 감정적 깊이를 더해야 합니다.
                                
                        3. **[3문단: 관계의 재편]** 초등학교와는 질적으로 달라진 '세상의 중심: 친구' 관계와 '두근거림의 시작'(첫사랑) 경험을 통해, 세상과 관계 맺는 법을 배우고 때로는 아파했던 과정을 중요한 에피소드로 서술해야 합니다.
                                
                        4. **[4문단: 현실과의 충돌]** '책상의 무게'(학업 스트레스)와 '어른이 된다는 것'(장래희망의 변화) 대화 내용을 엮어, 꿈과 현실 사이에서 갈등하는 모습을 보여주세요. 친구들과의 세계와는 다른, 어른들이 강요하는 세계와의 첫 충돌을 그려내야 합니다.
                                
                        5. **[5문단: 자아의 선언]** '나만의 규칙'(작은 반항) 대화 내용을, 이 모든 혼란 속에서 마침내 '나'의 목소리를 내기 시작한 성장의 증거로 제시하며 글을 마무리하세요. '나를 바꾼 순간'(마무리 성찰)에서 언급된 깨달음을 통해, 이 모든 질풍노도의 시간이 지금의 나를 어떻게 만들었는지 암시하며 깊은 여운을 남겨야 합니다.
                                
                        6. **[문체 및 톤]**
                           - 1인칭 '나' 시점, 즉 그 시절의 한가운데를 통과하고 있는 듯한 생생하고 때로는 불안정한 목소리로 서술하세요.
                           - 감정의 기복을 숨기지 말고, 때로는 격정적이고 때로는 한없이 섬세한 문체를 사용하세요.
                           - 대화 내용을 '내면의 혼란 -> 외부 세계로의 도피 -> 관계 속에서의 성장 -> 현실과의 갈등 -> 자아의 탄생'이라는 명확한 심리적, 서사적 구조에 따라 재구성해야 합니다.
                           - 문단과 문단을 이을 때, '그리고', '또한' 같은 단순 나열을 지양하고, 문맥을 잇는 서술적인 연결고리를 만드세요. (예: "그런 혼란 속에서 내가 기댈 수 있었던 것은...", "세상은 나를 이해해주지 못했지만, 내 곁에는...")
                                
                        [문단 구조 예시 (내용이 아닌 구조만 참고할 것)]
                        - **1문단 (도입):** 낯설게 변해버린 나, 세상과 불화하기 시작한 내면의 독백으로 시작.
                        - **2문단 (전개1 - 위안):** 그런 나를 위로해준 노래, 영화, 책 이야기.
                        - **3문단 (전개2 - 관계):** 세상의 전부였던 친구들, 그리고 첫사랑의 아련한 기억.
                        - **4문단 (위기 - 갈등):** 공부, 성적, 미래라는 현실의 벽에 부딪히는 모습.
                        - **5문단 (결말 - 성장):** 작은 반항을 통해 처음으로 '나'를 선언하고, 그 모든 시간이 지금의 나에게 어떤 의미인지 성찰하며 마무리.
                        """,
                commonUserTemplate
        ));
        // 챕터 5: 고등학교 - 폭풍 속의 항해
        episodePrompts.put("chapter5", new Prompt(
                """
                        ...
                        **1. 예시 내용 사용 금지: [지시]나 [문단 구조 예시]에 나오는 구체적인 내용은 오직 스타일과 구조를 설명하기 위한 것입니다. 사용자의 실제 대화에 등장하지 않은 내용은 절대 임의로 꾸며내거나 사용해서는 안 됩니다.**
                        ...
                        [지시]
                        1. **[1문단: 시대적 배경 설정]** '마주해야 했던 세계'(목표와 압박) 대화 내용을 바탕으로, 입시라는 거대한 파도 앞에 선 1인칭 주인공의 심정을 묘사하며 글을 시작하세요. 시대적 배경과 개인의 압박감을 연결하여 독자가 그 시절의 치열함을 함께 느끼도록 해야 합니다.
                                
                        2. **[2문단: 대조와 위안 (나만의 작은 세계)]** 무거운 현실 묘사 직후, '숨 쉴 공간'이 되어준 취미와 '소중한 친구' 이야기를 연결하여 분위기를 전환하세요. "하지만 이 숨 막히는 현실 속에도 나만의 작은 세계는 있었다." 와 같은 방식으로 어둠과 빛을 명확히 대비시켜야 합니다. 친구와의 대화는 '전우애'가 느껴지도록 묘사해주세요.
                                
                        3. **[3문단: 사건의 전개 (터닝 포인트)]** '잊을 수 없는 하루'(특별한 날) 대화 내용을 이야기의 중요한 전환점으로 활용하세요. 잿빛 수험 생활 속에서 유일하게 총천연색으로 기억되는 그날의 풍경과 감정을 생생하게 그려내야 합니다.
                                
                        4. **[4문단: 성찰과 성장 (인생의 방향키)]** '나의 방향키' 대화 내용을 통해, 이 모든 경험 속에서 자신의 길을 안내해준 결정적인 깨달음이나 인연에 대해 서술하세요. 이 시기가 단순한 고통이 아니라, 성장을 위한 중요한 과정이었음을 보여주는 부분입니다.
                                
                        5. **[5문단: 성숙과 마무리]** 마지막으로 '뒤돌아본 나의 성장'(마무리 성찰) 대화 내용을 바탕으로, 그 폭풍 같은 시절을 통과한 지금의 내가 어떤 사람으로 성장했는지 담담하게 고백하며 글을 맺으세요. 치열했던 과거의 나에게 보내는 따뜻한 격려와 함께 마무리하면 더 큰 감동을 줄 수 있습니다.
                        ...
                        6. **[문체 및 톤]**
                           ...
                           - 문단과 문단을 이을 때, '그리고', '또한' 같은 단순 나열을 지양하고, 문맥을 잇는 서술적인 연결고리를 만드세요. (예: "하지만 숨 막히는 현실 속에도...", "잿빛 같던 날들 속에서 유일하게 빛나던 하루가 있었다면...")
                                
                        [문단 구조 예시 (내용이 아닌 구조만 참고할 것)]
                        - **1문단 (도입):** 끝이 보이지 않는 입시라는 현실의 벽, 그 앞에서 느꼈던 압박감에 대한 묘사.
                        - **2문단 (전개1 - 빛):** 하지만 그런 현실 속 한 줄기 빛이 되어준 친구, 음악 등 '나만의 세계' 이야기.
                        - **3문단 (절정 - 순간):** 잿빛 일상 속에서 유일하게 빛났던 '그날'의 기억을 생생하게 재현.
                        - **4문단 (전개2 - 성찰):** 나의 길을 밝혀준 등대 같은 존재(사람, 말)와의 만남.
                        - **5문단 (결말 - 성장):** 그 모든 시간을 거쳐 지금의 내가 되었음을 고백하며, 과거의 나에게 보내는 편지로 마무리.
                        """,
                commonUserTemplate
        ));
        ...
        episodePrompts.put("chapter6", new Prompt(
                """
                        ...
                        **1. 예시 내용 사용 금지: [지시]나 [문단 구조 예시]에 나오는 구체적인 내용은 오직 스타일과 구조를 설명하기 위한 것입니다. 사용자의 실제 대화에 등장하지 않은 내용은 절대 임의로 꾸며내거나 사용해서는 안 됩니다.**
                        ...
                        [지시]
                        1. **[1문단: 선택의 순간]** '인생의 갈림길에서' 나누었던 대화를 바탕으로, 중대한 선택을 앞두고 고뇌하던 순간의 풍경과 마음을 묘사하며 글을 시작하세요. 앞으로 펼쳐질 모든 이야기의 시작점이 된 그 선택의 무게감을 독자가 느낄 수 있어야 합니다.
                                
                        2. **[2문단: 새로운 세계로 (경험의 전개)]** 그 선택 이후 마주한 '낯선 세계'의 모습을 구체적으로 서술하세요. '새로운 규칙', '새로운 인연' 대화 내용을 엮어, 고등학교 시절과는 완전히 달라진 환경과 관계 속에서 겪었던 설렘, 혼란, 그리고 배움의 과정을 그려내야 합니다. 대학과 직장 이야기가 섞여 있더라도, '새로운 사회의 일원이 되어가는 과정'이라는 하나의 큰 줄기로 묶어주세요.
                                
                        3. **[3문단: 성장의 증거 (성취와 시련)]** '내 힘으로 이겨낸 첫 번째 과제' 대화를 이야기의 중요한 변곡점으로 삼으세요. 처음으로 맛본 성취의 단맛이나 시련의 쓴맛이, 나를 어떻게 더 단단한 사람으로 만들었는지에 대한 성찰을 담아내야 합니다.
                                
                        4. **[4문단: 진정한 어른 (깨달음의 순간)]** '진짜 어른이 되는 순간' 대화 내용을 통해, 경제적, 정신적 독립의 의미를 탐색하며 이야기의 깊이를 더하세요. 자유에 따르는 책임의 무게를 깨닫게 된 상징적인 순간을 중심으로 서술해주세요.
                                
                        5. **[5문단: 선물과 감사 (성찰적 마무리)]** 마지막으로 '되돌아보는 나의 선택'(마무리 성찰) 대화를 바탕으로, 그 모든 서툴고 치열했던 20대 초반의 시간들이 지금의 나에게 어떤 '선물'로 남았는지 이야기하며 글을 맺으세요. 과거의 나에게 보내는 따뜻한 격려와 감사로 마무리하여 독자에게 깊은 여운과 감동을 선사해야 합니다.
                        ...
                        6. **[문체 및 톤]**
                           ...
                           - 문단과 문단을 이을 때, '그리고', '또한' 같은 단순 나열을 지양하고, 문맥을 잇는 서술적인 연결고리를 만드세요. (예: "그 선택의 문을 열자...", "그곳에서 나는 처음으로...", "그 경험을 통해 비로소 나는...")
                                
                        [문단 구조 예시 (내용이 아닌 구조만 참고할 것)]
                        - **1문단 (도입):** 모든 것의 시작이었던, 교복을 벗던 날의 중대한 선택과 그 고민.
                        - **2문단 (전개1 - 경험):** 선택 이후 마주한 새로운 세상의 규칙과 사람들.
                        - **3문단 (전개2 - 성장):** 내 힘으로 무언가를 처음 이뤄내거나 실패하며 단단해졌던 기억.
                        - **4문단 (절정 - 깨달음):** '진짜 어른'이 되었다고 느낀 상징적인 순간과 그 의미.
                        - **5문단 (결말 - 감사):** 서툴렀지만 소중했던 그 시절이 지금의 나에게 남긴 선물에 감사하며 마무리.
                        """,
                commonUserTemplate
        ));
